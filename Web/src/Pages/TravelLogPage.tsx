...
import { HiStar, HiTrash, HiCalendar, HiLocationMarker } from "react-icons/hi";
      ...
      <main className={`max-w-7xl mx-auto px-6 py-10 pb-20`}>
        <div className={`text-center ${isMobile ? "mb-8" : "mb-12"}`}>
          ...
          <button
            ...
            className="mt-6 inline-flex items-center px-5 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/20"
          >
            New Trip Log
          </button>
        </div>
