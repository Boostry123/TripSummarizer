      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed">
            ...
            <p>
              Our mission is to help you build a "Travel DNA"—a digital
              synthesis of your unique preferences, biases, and desires. By
            ...
            <p>
              ...
              everyone, TripSummarizer uses advanced AI to traverse your
              personal data. It understands that "crowded" might be a
              dealbreaker for one person but "vibrant" for another. It looks for
              patterns in your free-text narratives to find hidden gems you
